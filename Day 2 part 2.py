passtr = """17-19 p: pwpzpfbrcpppjppbmppp
...
def passchecker(code):
    ...
    numscan = (x[0].split('-'))
    letter = (x[1].split(':'))
    letcount = [char for char in x[2]]

    if letcount[int(numscan[0])-1] == letter[0] and letcount[int(numscan[1])- 1] != letter[0]:
        return True
    elif letcount[int(numscan[1])- 1] == letter[0] and letcount[int(numscan[0])-1] != letter[0]:
        return True
    else:
        return False
